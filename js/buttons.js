!(function () {
  ...
  var o = window.document,
    ...
    M = {
      ...
      "issue-opened": {
        heights: {
          16: { width: 16, path: '<path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path><path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Z"></path>' },
        },
      },
      "mark-github": {
        heights: {
    ...
    L = function (o, e, t) {
      ...
      if (
        ((((u === c || u === "gist." + c) && "archive" === h[3]) || (u === c && "releases" === h[3] && ("download" === h[4] || ("latest" === h[4] && "download" === h[5]))) || u === "codeload." + c) &&
          (d.target = "_top"),
